...
# Choose the best value of K (i.e. tune the hyperparameter K). Use a 10-fold cross-validation instead of a single split
...
# Evaluate the model
confusion_matrix_knn <- confusionMatrix(knn_pred, test_data$diagnosis)
